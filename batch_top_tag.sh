...
./AGILETopTagger --file=~/scratch_space/mc12_8TeV_JZX_Zprime_perfntuple_shuffled.root --tree=top_train_ntup --save=AGILETopTagger_no_pretrain_"${formulas[$PBS_ARRAYID-1]}".yaml --learning=0.0006 --momentum=0.86 --batch=1 --config=./top_tag_config.yaml -uepochs=0 -d0 -sepochs=${train_time[$PBS_ARRAYID-1]} -start=0 -end=1671000 --type=binary --formula=${formulas[$PBS_ARRAYID-1]} --struct=${structures[$PBS_ARRAYID-1]}
./AGILETopTagger --file=~/scratch_space/mc12_8TeV_JZX_Zprime_perfntuple_shuffled.root --tree=top_train_ntup --save=AGILETopTagger"${formulas[$PBS_ARRAYID-1]}".yaml --learning=0.0006 --momentum=0.86 --batch=1 --config=./top_tag_config.yaml -uepochs=35 -sepochs=${train_time[$PBS_ARRAYID-1]} -start=0 -end=1671000 --type=binary --formula=${formulas[$PBS_ARRAYID-1]} --struct=${structures[$PBS_ARRAYID-1]}
